package org.market.hedge.bibox.coinswap.marketdata;
...
public class BiboxCoinSwapMarketDataTest {

    private static Logger logger= LoggerFactory.getLogger(BiboxCoinSwapMarketDataTest.class);

    @Test
    public void getOrderBook(){
        MHExchange bibox= MHExchangeFactory.INSTANCE.createExchange(BiboxExchange.class, TradingArea.CoinSwap);
