...
public class BinanceOptionBaseService extends BaseResilientExchangeService<BinanceExchange> {
    ...
    protected BinanceOptionBaseService(
            BinanceExchange exchange,
            BinanceOptionAuthenticated binance,
