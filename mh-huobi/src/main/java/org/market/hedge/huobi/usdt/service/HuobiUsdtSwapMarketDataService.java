...
public class HuobiUsdtSwapMarketDataService  extends HuobiUsdtSwapMarketDataServiceRaw implements MHMarketDataService {


    public HuobiUsdtSwapMarketDataService(Exchange exchange) {
        super(exchange);
    }
