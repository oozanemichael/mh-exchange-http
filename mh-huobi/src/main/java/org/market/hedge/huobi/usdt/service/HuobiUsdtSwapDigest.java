...
public class HuobiUsdtSwapDigest extends BaseParamsDigest {

  private final Field invocationUrlField;
  private static final String PLACEHOLDER = "HUOBI_PLACEHOLDER";

  private HuobiUsdtSwapDigest(String secretKey) {
  ...
  static HuobiUsdtSwapDigest createInstance(String secretKey) {
    return secretKey == null ? null : new HuobiUsdtSwapDigest(secretKey);
  }
