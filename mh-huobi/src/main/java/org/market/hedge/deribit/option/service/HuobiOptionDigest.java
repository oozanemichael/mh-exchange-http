...
public class HuobiOptionDigest extends BaseParamsDigest {

  private final Field invocationUrlField;
  private static final String PLACEHOLDER = "HUOBI_PLACEHOLDER";

  private HuobiOptionDigest(String secretKey) {
  ...
  static HuobiOptionDigest createInstance(String secretKey) {
    return secretKey == null ? null : new HuobiOptionDigest(secretKey);
  }
