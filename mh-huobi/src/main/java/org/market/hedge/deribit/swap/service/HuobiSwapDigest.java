package org.market.hedge.deribit.swap.service;
...
public class HuobiSwapDigest extends BaseParamsDigest {
  ...
  static HuobiSwapDigest createInstance(String secretKey) {
    return secretKey == null ? null : new HuobiSwapDigest(secretKey);
  }
