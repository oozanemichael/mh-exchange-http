...
public class HuobiFuturesDigest extends BaseParamsDigest {

  private final Field invocationUrlField;
  private static final String PLACEHOLDER = "HUOBI_PLACEHOLDER";

  private HuobiFuturesDigest(String secretKey) {
  ...
  static HuobiFuturesDigest createInstance(String secretKey) {
    return secretKey == null ? null : new HuobiFuturesDigest(secretKey);
  }
